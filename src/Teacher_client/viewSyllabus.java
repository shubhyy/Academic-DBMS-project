  ...
  //  S2 s= new S2();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					viewSyllabus window = new viewSyllabus();
	...
	private void initialize() {
        ...
        button_2.setBounds(54, 195, 117, 25);
		...
		lblControlPanel.setText("Syllabus : ");
		...
		String[] cols= {"Topic Name","Number of Lecture"}; 
		 table_1 = new JTable();
	       ...
	       c1.test();
	        ...
	        ResultSet rs= c1.st.executeQuery("SELECT * FROM SMS.topic,SMS.subject where sub_name='"+p1.selectedSub+"'and subject.sub_code=topic.sub_code;");
